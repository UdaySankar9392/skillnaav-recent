...
const PatnerLogin = () => {
  ...
  const handleGoogleLogin = (response) => {
    ...
    navigate("/patner-verification"); // Adjust this to your desired path
  };
        ...
        <div className="w-full max-w-md flex flex-col justify-center min-h-screen lg:min-h-full">
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              setTimeout(() => {
                setSubmitting(false);
                navigate("/patner-verification"); // Navigate to verification code screen
              }, 400);
            }}
          >
            {({ isSubmitting }) => (
