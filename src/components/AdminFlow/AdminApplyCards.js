...
const AdminApplyCards = ({ job, onBack }) => {
  const { savedJobs = [], applications = [], saveJob, removeJob, applyJob } = useAdminContext();
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg max-w-full mx-auto p-4 sm:p-6 lg:p-8 xl:p-12 overflow-auto">
...
export default AdminApplyCards;
